...
public class Conll2002ChunkTagParser extends StringParser<ObjectHandler<Chunking>> {
	// multi-token gene: first token tagged as B-protein or B-rna or B-dna
	// consecutive tokens for the same entity are taggged I-protein or I-rna or I-dna respectively
	// we are only interested in  B-Protein/I-protein, B-rna/I-rna, B-dna/I-dna, and treat them all the same way
    /*
    ...
    static final int TOKEN_GROUP = 1; // index of token subgroup in TOKEN_TAG_LINE_REGEX
    static final int TAG_GROUP = 3;   // index of entityTag subgroup in TOKEN_TAG_LINE_REGEX
    /*
